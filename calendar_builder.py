...
def game_matches_spec(game: Game, spec: CalendarSpec) -> bool:
    ...
    is_medal_game = game.phase_key in {"bronze", "gold"}
    return (spec.include_team_cze and is_czech_game) or (spec.include_playoff and is_playoff) or (spec.include_final and is_medal_game)
